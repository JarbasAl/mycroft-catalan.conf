...
Això document és una traducció de l'original en anglès que podeu [aquí](readme.md).

- [Traducció del nucli (mycroft-core)](#translating-core)
- [Traducció de les habilitats (skills)](#translating-skills)
  * [translate.mycroft.ai](#translatemycroftai)
  * [Exportació manual des de Pootle](#exporting-pootle-manually)
  * [Traducció manual](#manual-translation)
    + [Codi de llengua (locale)](#locale)
    + [Fitxers de recursos](#resource-files)
    + [Sol·licitud d'entrada (pull request)](#pull-request)
  * [Casos especials](#corner-cases)
  * [Substitució d'habilitats](#replacing-skills)
    + [Habilitat de bromes (jokes)](#jokes)
    + [Habilitat de notícies](#news-skill)
      - [Configuració del d'àudio](#configuring-audio-backend)
    + [Blocatge d'habilitats oficials (blacklist)](#blacklist-official-skills)
- [Instal·lació d'extensions (plugins)](#installing-plugins)
  * [Intal·lació manual](#manual-install)
  * [Mycroft-pip](#mycroft-pip)
  * [A partir del codi font](#from-source)
- [Lingua franca](#lingua-franca)
- [mycroft.conf](#mycroftconf)
  * [Llengua (lang)](#lang)
    + [Configuració de la llengua](#lang-config)
  * [Reconeixement de la parla (STT, Speech to Text)](#stt---speech-to-text)
    + [Llista de motors del nucli que admeten el català](#list-of-core-engines-that-support-catalan)
    + [Llista de mòduls que admeten el català](#list-of-plugins-that-support-catalan)
    + [Configuració de l'STT](#stt-config)
      - [Instal·lació de jarbas-stt-plugin-chromium](#installing-jarbas-stt-plugin-chromium)
  * [Síntesi de veu (TTS, Text to Speech)](#tts---text-to-speech)
    + [Llista de motors del nucli que admeten el català](#list-of-core-engines-that-support-catalan-1)
    + [Llista de mòduls que admeten el català](#list-of-plugins-that-support-catalan-1)
    + [Configuració del TTS](#tts-config)
      - [Instal·lació de festival](#installing-festival)
  * [Paruaules d'activació](#wake-words)
    + [Precise 0.3](#precise-03)
    + [Precise 0.2](#precise-02)
    + [Paraula d'activació - Ei ordinador](#wake-word---ey-ordenador)
    + [Paraula despertadora (stand up) - Desperta](#standup-word---desperta)
- [Configuracó final](#final-config)
