...
- [Mycroft en català](#mycroft-en-catal-)
- [Traducció del nucli (core)](#traducci--del-nucli--core-)
- [Traducció de les habilitats (skills)](#traducci--de-les-habilitats--skills-)
  * [translate.mycroft.ai](#translatemycroftai)
  * [Exportació manual des de Pootle](#exportaci--manual-des-de-pootle)
  * [Traducció manual](#traducci--manual)
    + [Codi de llengua (locale)](#codi-de-llengua--locale-)
    + [Fitxers de recursos](#fitxers-de-recursos)
    + [Sol·licitud d'entrada (pull request)](#sol-licitud-d-entrada--pull-request-)
  * [Casos especials](#casos-especials)
  * [Substitució d'habilitats](#substituci--d-habilitats)
    + [Habilitat de bromes (jokes)](#habilitat-de-bromes--jokes-)
    + [Habilitat de notícies](#habilitat-de-not-cies)
      - [Configuració del motor d'àudio](#configuraci--del-motor-d--udio)
    + [blacklist official skills](#blacklist-official-skills)
- [Instal·lació d'extensions (plugins)](#instal-laci--d-extensions--plugins-)
  * [Instal·lació manual](#instal-laci--manual)
...
- [mycroft.conf](#mycroftconf)
  * [Llengua (lang)](#llengua--lang-)
    + [Configuració de la llengua](#configuraci--de-la-llengua)
  * [Reconeixement de la parla (STT, Speech to Text)](#reconeixement-de-la-parla--stt--speech-to-text-)
    + [Llista de motors del nucli que admeten el català](#llista-de-motors-del-nucli-que-admeten-el-catal-)
    + [Llista d'extensions que admeten el català](#llista-d-extensions-que-admeten-el-catal-)
    + [Configuració de l'STT](#configuraci--de-l-stt)
      - [Instal·lació de jarbas-stt-plugin-chromium](#instal-laci--de-jarbas-stt-plugin-chromium)
  * [Síntesi de veu (TTS, Text to Speech)](#s-ntesi-de-veu--tts--text-to-speech-)
    + [Llista de motors del nucli que admeten el català](#llista-de-motors-del-nucli-que-admeten-el-catal--1)
    + [Llista d'extensions que admeten el català](#llista-d-extensions-que-admeten-el-catal--1)
    + [Configuració del motor TTS](#configuraci--del-motor-tts)
      - [Instal·lació de festival](#instal-laci--de-festival)
  * [Paraules d'activació (wake words)](#paraules-d-activaci---wake-words-)
    + [Precise 0.3](#precise-03)
    + [Precise 0.2](#precise-02)
    + [Paraula d'activació - Ei ordinador](#paraula-d-activaci----ei-ordinador)
    + [Paraula despertadora (stand up) - Desperta](#paraula-despertadora--stand-up----desperta)
- [Configuració final](#configuraci--final)
